...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React45 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState25 = React45.useState, useEffect31 = React45.useEffect, useLayoutEffect4 = React45.useLayoutEffect, useDebugValue = React45.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var RovingFocusGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = React22.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [focusableItemsCount, setFocusableItemsCount] = React22.useState(0);
  React22.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime11.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React22.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React22.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React22.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React22.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React22.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var MenuContent = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime12.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime12.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime12.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime12.jsx)(
          Primitive.div,
          {
            role: "menuitem",
...
var MenuSubContent = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React23.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime12.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime12.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime12.jsx)(
      MenuContentImpl,
      {
...
var ContextMenuTrigger = React24.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React24.useRef({ x: 0, y: 0 });
    const virtualRef = React24.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React24.useRef(0);
    const clearLongPress = React24.useCallback(
    ...
    React24.useEffect(() => clearLongPress, [clearLongPress]);
    React24.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React24.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React24.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React24.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React24.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React24.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React24.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React24.forwardRef((props, forwardedRef) => {
...
var NAME3 = "Label";
var Label3 = React26.forwardRef((props, forwardedRef) => {
...
var Form = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, onClearServerErrors = () => {
    }, ...rootProps } = props;
    const formRef = React27.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React27.useState({});
    const getFieldValidity = React27.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React27.useCallback(
    ...
    const handleFieldValiditionClear = React27.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React27.useState({});
    const getFieldCustomMatcherEntries = React27.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React27.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React27.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React27.useState({});
    const getFieldCustomErrors = React27.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React27.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React27.useState({});
    const handleFieldMessageIdAdd = React27.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React27.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React27.useCallback(
...
var FormField = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const id = useId();
    return (0, import_jsx_runtime16.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime16.jsx)(
      Primitive.div,
      {
...
var FormControl = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React27.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React27.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    if (match === void 0) {
      return (0, import_jsx_runtime16.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime16.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime16.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime16.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React27.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime16.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime16.jsx)(Primitive.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime16.jsx)(import_jsx_runtime16.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime16.jsx)(Primitive.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime17.jsx)(Root22, { ...popperScope, children })
    }
  );
};
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime17.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime17.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var Menubar = React29.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React29.useState(null);
    return (0, import_jsx_runtime18.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React29.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React29.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React29.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React29.useRef(false);
...
var MenubarTrigger = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React29.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React29.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React29.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React30.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React30.useState(null);
    ...
    const startCloseTimer = React30.useCallback(() => {
...
var NavigationMenuSub = React30.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React30.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React30.useState(null);
  return (0, import_jsx_runtime19.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React30.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React30.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React30.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React30.useRef(null);
    const restoreContentTabOrderRef = React30.useRef(() => {
    });
    const wasEscapeCloseRef = React30.useRef(false);
    const handleContentEntry = React30.useCallback((side = "start") => {
    ...
    const handleContentExit = React30.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
...
var NavigationMenuTrigger = React30.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React30.useRef(false);
...
var NavigationMenuLink = React30.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React30.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React30.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React30.useState(
    null
  );
  const [position, setPosition] = React30.useState(null);
...
var NavigationMenuContent = React30.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React30.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME10, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React30.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React30.useRef(null);
  ...
  const motionAttribute = React30.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React30.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React30.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React30.useState(null);
...
var FocusGroup = React30.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React30.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React31.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React31.useCallback(
      (value2) => {
    ...
    const controlledValue = React31.useMemo(() => {
    ...
    const validationTypeRef = React31.useRef(validation);
    React31.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React31.useRef(null);
    const userActionRef = React31.useRef(null);
    ...
    const locateForm = React31.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React31.useCallback(() => {
    ...
    const valueRef = React31.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React31.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React31.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React31.useState(null);
  ...
  const keyboardActionTimeoutRef = React31.useRef(null);
  React31.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React32.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React32.useCallback(
  ...
  const focusState = React32.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React32.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React32.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React32.useState(void 0);
...
var PasswordToggleFieldIcon = React32.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var PopoverContentModal = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime22.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime22.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var SelectContentImpl = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst5 = React37.useCallback(
      (candidates) => {
    ...
    return (0, import_jsx_runtime27.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime27.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime27.jsx)(
          FocusScope,
          {
            asChild: true,
...
var Separator4 = React38.forwardRef((props, forwardedRef) => {
...
var SwitchBubbleInput = React40.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var TabsContent = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React41.useRef(isSelected);
    React41.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
var NAME5 = "Toggle";
var Toggle = React42.forwardRef((props, forwardedRef) => {
...
var Toolbar = React44.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React44.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React44.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React44.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React44.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React44.forwardRef(
  (props, forwardedRef) => {
